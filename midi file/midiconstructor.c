...
int main(int argc, char *argv[]) {
    ...
    FILE *fichier_midi = fopen("output.mid", "wb") ;
    MIDI_ecrire_en_tete(fichier_midi, 1, 2, 128) ;
...
void MIDI_delta_time(FILE *fichier, unsigned long duree) {     ecrire_variable_length_quantity(fichier, duree) ;
 }
...
void ecrire_piste2(FILE *fichier) {
     ...
     MIDI_Program_Change(fichier, 0, 23) ;
